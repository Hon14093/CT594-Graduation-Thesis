...
export function DetailsModal({ storage, open, onClose }) {
                ...
                <section className='grid md:grid-cols-2 sm:grid-cols-1 gap-5 items-start text-lg'>
                    <ScrollArea className='grid gap-2 h-[25rem] overflow-hidden'>
                        ...
                        <div className="flex">
                            ...
                            <p className="whitespace-normal break-words">{storage.storage_name}</p>
                        </div>
                        ...
                        <div className='flex pb-2'>
                            ...
                            <p>{storage.price.toLocaleString()} vnđ</p>
                        </div>

                        {/* {renderSpecsTable()} */}

                        <SpecsTable data={storage} />
                    ...
                    <article>
                        ...
                        <Carousel className="w-full" opts={{ loop: true, align: "center" }}>
                            <CarouselContent>
                                {storage.image_url.map((image, index) => (
